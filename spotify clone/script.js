...
function convertSecondsToMinutesSeconds(seconds) {
  ...
  return Math.round(minutesString) + ":" + Math.round(secondsString);
}
...
async function main() {
  ...
  //add an eveent listener for hamburger
  document.querySelector(".hamburger").addEventListener("click", () => {
    document.querySelector(".left").style.left = "0";
  });

  //add an eveent listener for close
